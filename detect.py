...
class Detector():
    def __init__(self, **kwargs):
        ...
        self.tta_datagen = ImageDataGenerator(samplewise_center=True,
                                              samplewise_std_normalization=True,brightness_range=(0.8, 1.2),
                                              rotation_range=10,
                                              width_shift_range=0.10,
                                              height_shift_range=0.10,
                                              zoom_range=0.10,
                                              horizontal_flip=True)
        self.datagen = ImageDataGenerator(samplewise_center=True,
...
if __name__ == '__main__':
    ...
    test_args['tta'] = 10
    test_args['cam'] = False
    test_args['model'] = 'vgg16'
    test_args['path'] = 'data/demo/happy.jpg'
